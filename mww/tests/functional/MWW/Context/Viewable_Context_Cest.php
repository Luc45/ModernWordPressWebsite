...
add_action( 'init', function () {
	 echo (int) \MWW\Service_Providers\Viewable_Service_Provider::should_register();
	exit;
} );
PHP;
...
add_action( 'wp', function () {
	 echo sprintf('<div id="test-rest-response">%d</div>', (int) \MWW\Service_Providers\Viewable_Service_Provider::should_register());
	exit;
} );
PHP;
